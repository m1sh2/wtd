...
export class GamePhaser {
  start() {
    ...
    function preload() {
      ...
      game.load.bitmapFont('font', 'fonts/font.png', 'fonts/font.xml');

      game.load.spritesheet('cannon', 'images/cannon.png', 64, 64, 8);
      game.load.spritesheet('coin', 'images/coin.png', 24, 24, 8);
      game.load.spritesheet('dude', 'images/dude.png', 32, 48);
      game.load.spritesheet('wall', 'images/wall.png', 64, 192, 4);
      game.load.spritesheet('button', 'images/button.png', 32, 96, 1);
