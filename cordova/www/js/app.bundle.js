...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(/*! /Users/mike/Documents/my/wtd/cordova/_src/app/main.js */298);
	module.exports = __webpack_require__(/*! /Users/mike/Documents/my/wtd/cordova/_src/assets/css/styles.css */354);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _boot = __webpack_require__(/*! ./states/boot/boot */ 305);

	var _boot2 = _interopRequireDefault(_boot);

	var _splashBoot = __webpack_require__(/*! ./states/splash/splash-boot */ 342);

	var _splashBoot2 = _interopRequireDefault(_splashBoot);

	var _splashPlay = __webpack_require__(/*! ./states/splash/splash-play */ 343);

	var _splashPlay2 = _interopRequireDefault(_splashPlay);

	var _battle = __webpack_require__(/*! ./states/battle/battle */ 344);

	var _battle2 = _interopRequireDefault(_battle);

	var _home = __webpack_require__(/*! ./states/home/home */ 348);

	var _home2 = _interopRequireDefault(_home);

	var _settings = __webpack_require__(/*! ./states/settings/settings */ 349);

	var _settings2 = _interopRequireDefault(_settings);

	var _lab = __webpack_require__(/*! ./states/lab/lab */ 350);

	var _lab2 = _interopRequireDefault(_lab);

	var _market = __webpack_require__(/*! ./states/market/market */ 351);

	var _market2 = _interopRequireDefault(_market);

	var _play = __webpack_require__(/*! ./states/play/play */ 352);

	var _play2 = _interopRequireDefault(_play);

	var _win = __webpack_require__(/*! ./states/win/win */ 353);
	...
	var Game = function (_Phaser$Game) {
	  ...
	  function Game() {
	    ...
	    var width = document.documentElement.clientWidth * _utils.U.ratio;
	    var height = document.documentElement.clientHeight * _utils.U.ratio;
	    ...
	    _this.state.add('SplashBoot', _splashBoot2.default, false);
	    _this.state.add('SplashPlay', _splashPlay2.default, false);
	    _this.state.add('Battle', _battle2.default, false);
	    _this.state.add('Home', _home2.default, false);
	    _this.state.add('Settings', _settings2.default, false);
	    _this.state.add('Lab', _lab2.default, false);
	    _this.state.add('Market', _market2.default, false);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function init() {
	      ...
	      if (!_utils.U.mem.get('sets')) {
	        _utils.U.mem.set('sets', sets);
	      }
	      // this.fontsReady = false
	      // this.fontsLoaded = this.fontsLoaded.bind(this)
	      setTimeout(function () {
	        _this2.state.start('SplashBoot');
	      }, 1000);
	    }
	  }, {
	    key: 'preload',
	    value: function preload() {
	      ...
	      this.load.image('loaderBg', __webpack_require__(/*! ../../../assets/images/loader-bg.png */ 329));
	      this.load.image('loaderBar', __webpack_require__(/*! ../../../assets/images/loader-bar.png */ 330));
	      this.load.image('splash-bg', __webpack_require__(/*! ../../../assets/images/splash-bg.png */ 331));
	      this.load.spritesheet('splash-logo', __webpack_require__(/*! ../../../assets/images/splash-logo.png */ 332), 909, 512);

	      this.load.spritesheet('enemy-bug', __webpack_require__(/*! ../../../assets/images/enemies/bug.png */ 333), 128, 128, 1);

	      // User UI
	      this.load.spritesheet('coin', __webpack_require__(/*! ../../../assets/images/coin.png */ 334), 96, 96, 8);

	      // Static game UI
	      this.load.spritesheet('wall', __webpack_require__(/*! ../../../assets/images/wall/wall.png */ 335), 997, 85, 1);

	      // Weapons
	      this.load.spritesheet('w1', __webpack_require__(/*! ../../../assets/images/weapons/weapon-gun-2.png */ 336), 288, 288, 6);
	      this.load.spritesheet('base', __webpack_require__(/*! ../../../assets/images/weapons/weapon-base-2.png */ 337), 256, 256, 7);
	      this.load.spritesheet('range-w1', __webpack_require__(/*! ../../../assets/images/weapons/weapon-range-w1.png */ 338), 1024, 1024, 1);

	      // Cars
	      this.load.spritesheet('car-1', __webpack_require__(/*! ../../../assets/images/3d/car-1.png */ 339), 600, 300, 1);
	      this.load.spritesheet('car-1-range', __webpack_require__(/*! ../../../assets/images/weapons/weapon-range-w1.png */ 338), 1024, 1024, 1);

	      // Levels
	      this.load.spritesheet('level-1', __webpack_require__(/*! ../../../assets/images/levels/level-1.png */ 340), 2048, 1024, 8);
	      this.load.spritesheet('level-2', __webpack_require__(/*! ../../../assets/images/levels/level-2.png */ 341), 512, 1024, 1);
	    }
	  }, {
	    key: 'render',
	    ...
	    value: function create() {
	      this.game.scale.scaleMode = _phaser2.default.ScaleManager.NO_SCALE;
	      this.game.scale.fullScreenScaleMode = _phaser2.default.ScaleManager.NO_SCALE;
	      ...
	      this.loaderBg = this.add.sprite(this.game.world.centerX, this.game.height - 5 * _utils.U.ratio, 'loaderBg');
	      this.loaderBar = this.add.sprite(this.game.world.centerX, this.game.height - 5 * _utils.U.ratio, 'loaderBar');

	      _utils.U.setCenter([this.loaderBg, this.loaderBar, this.splashLogo]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _buttons = __webpack_require__(/*! ./buttons/ */ 308);

	var _content = __webpack_require__(/*! ./content/ */ 312);

	var _addMap = __webpack_require__(/*! ./map/add-map */ 315);

	var _removeMap = __webpack_require__(/*! ./map/remove-map */ 316);

	var _addTitle = __webpack_require__(/*! ./title/add-title */ 317);

	var _removeTitles = __webpack_require__(/*! ./title/remove-titles */ 318);

	var _addMenu = __webpack_require__(/*! ./menu/add-menu */ 319);

	var _removeMenu = __webpack_require__(/*! ./menu/remove-menu */ 320);

	var _getRatio = __webpack_require__(/*! ./get-ratio */ 321);

	var _getView = __webpack_require__(/*! ./get-view */ 322);

	var _getWeaponsPositions = __webpack_require__(/*! ./get-weapons-positions */ 323);

	var _getRadians = __webpack_require__(/*! ./get-radians */ 324);

	var _setCenter = __webpack_require__(/*! ./set-center */ 325);

	var _setResponsiveWidth = __webpack_require__(/*! ./set-responsive-width */ 326);

	var _hasChildren = __webpack_require__(/*! ./has-children */ 327);

	var _storage = __webpack_require__(/*! ./storage */ 328);

	var U = exports.U = {
	  btns: {
	    add: _buttons.addButton,
	    clear: _buttons.clearButtons
	  },

	  cnt: {
	    add: _content.addContent,
	    clear: _content.clearContent
	  },

	  map: {
	    add: _addMap.addMap,
	    remove: _removeMap.removeMap
	  },

	  title: {
	    add: _addTitle.addTitle,
	    remove: _removeTitles.removeTitles
	  },

	  menu: {
	    add: _addMenu.addMenu,
	    remove: _removeMenu.removeMenu
	  },

	  mem: {
	    get: _storage.getStorage,
	    set: _storage.setStorage
	  },

	  ratio: _getRatio.getRatio.ratio,
	  ratioS: _getRatio.getRatio.sprite,
	  view: _getView.getView,
	  getWeaponsPositions: _getWeaponsPositions.getWeaponsPositions,
	  getRadians: _getRadians.getRadians,

	  setCenter: _setCenter.setCenter,
	  setResponsiveWidth: _setResponsiveWidth.setResponsiveWidth,

	  hasChild: _hasChildren.hasChildren
	};

/***/ },
/* 308 */
/*!*****************************************!*\
  !*** ./_src/app/utils/buttons/index.js ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _addButton = __webpack_require__(/*! ./add-button */ 309);
	...
	var _clearButtons = __webpack_require__(/*! ./clear-buttons */ 311);

	Object.keys(_clearButtons).forEach(function (key) {
	  if (key === "default" || key === "__esModule") return;
	  Object.defineProperty(exports, key, {
	    enumerable: true,
	    get: function get() {
	      return _clearButtons[key];
	    }
	  });
	});
...
/* 309 */
/*!**********************************************!*\
  !*** ./_src/app/utils/buttons/add-button.js ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var addButton = exports.addButton = function addButton(options) {
	  ...
	  var $buttons = (0, _jquery2.default)('#buttons');
	  var $button = (0, _jquery2.default)('<span/>');
...
/* 311 */
/*!*************************************************!*\
  !*** ./_src/app/utils/buttons/clear-buttons.js ***!
  \*************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	exports.clearButtons = undefined;
	...
	var clearButtons = exports.clearButtons = function clearButtons() {
	  var $buttons = (0, _jquery2.default)('#buttons');
	  $buttons.html('');
	};
...
/* 312 */
/*!*****************************************!*\
  !*** ./_src/app/utils/content/index.js ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _addContent = __webpack_require__(/*! ./add-content */ 313);

	Object.keys(_addContent).forEach(function (key) {
	  if (key === "default" || key === "__esModule") return;
	  Object.defineProperty(exports, key, {
	    enumerable: true,
	    get: function get() {
	      return _addContent[key];
	    }
	  });
	});

	var _clearContent = __webpack_require__(/*! ./clear-content */ 314);

	Object.keys(_clearContent).forEach(function (key) {
	  if (key === "default" || key === "__esModule") return;
	  Object.defineProperty(exports, key, {
	    enumerable: true,
	    get: function get() {
	      return _clearContent[key];
	    }
	  });
	});
...
/* 313 */
/*!***********************************************!*\
  !*** ./_src/app/utils/content/add-content.js ***!
  \***********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var addContent = exports.addContent = function addContent(content, options) {
	  ...
	  var $element = (0, _jquery2.default)('<' + _options.type + '/>');
	  ...
	  if (_options.x) {
	    $element.css({ left: _options.x + 'px' });
	  }
	  if (_options.y) {
	    $element.css({ top: _options.y + 'px' });
	  }
	  if (_options.w) {
	    $element.css({ width: _options.w + 'px' });
	  }
	  if (_options.h) {
	    $element.css({
	      height: _options.h + 'px',
...
/* 314 */
/*!*************************************************!*\
  !*** ./_src/app/utils/content/clear-content.js ***!
  \*************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	exports.clearContent = undefined;
	...
	var clearContent = exports.clearContent = function clearContent() {
	  var $content = (0, _jquery2.default)('#content span, #content div');
	  $content.remove();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var addMap = exports.addMap = function addMap(levels, ctx) {
	  levels = typeof levels === 'undefined' ? [] : levels;

	  var map = (0, _jquery2.default)('<div/>');
	  var mapBg = (0, _jquery2.default)('<div/>');
	  var wWin = (0, _jquery2.default)(window).width();
	  var hWin = (0, _jquery2.default)(window).height();
	  var wMap = 2401;
	  var hMap = 1114;
	  ...
	  levels.forEach(function (level) {
	    var $level = (0, _jquery2.default)('<div/>');
	    ...
	    $level.click(function (event) {
	      ...
	      if (!level.locked) {
	        (0, _jquery2.default)('.map-level').addClass('hidden');
	        $level.addClass('opened');
	        (0, _jquery2.default)('#title').append('<span class="title-suffix"> - ' + level.label + '</span>');
	      }
	    });

	    var progress = 0;

	    level.subLevels.forEach(function (subLevel) {
	      var $subLevel = (0, _jquery2.default)('<div/>');
	      ...
	      $subLevel.click(function (event) {
	        event.stopPropagation();

	        if (!subLevel.locked) {
	          _utils.U.mem.set('level', level.id);
	          _utils.U.mem.set('subLevel', subLevel.id);
	  ...
	  (0, _jquery2.default)('#buttons').append(map);
...
/* 316 */
/*!******************************************!*\
  !*** ./_src/app/utils/map/remove-map.js ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var removeMap = exports.removeMap = function removeMap() {
...
/* 317 */
/*!*******************************************!*\
  !*** ./_src/app/utils/title/add-title.js ***!
  \*******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var addTitle = exports.addTitle = function addTitle(options) {
	  options = typeof options === 'undefined' ? {} : options;

	  var title = (0, _jquery2.default)('<div/>');
	  title.attr({
	    id: 'title'
	  });
	  ...
	  (0, _jquery2.default)('#content').append(title);
	};

/***/ },
/* 318 */
/*!***********************************************!*\
  !*** ./_src/app/utils/title/remove-titles.js ***!
  \***********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	exports.removeTitles = undefined;
	...
	var removeTitles = exports.removeTitles = function removeTitles() {
	  var $titles = (0, _jquery2.default)('.title');
	  $titles.remove();
	};
...
/* 319 */
/*!*****************************************!*\
  !*** ./_src/app/utils/menu/add-menu.js ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var addMenu = exports.addMenu = function addMenu(o) {
	  o = typeof o === 'undefined' ? {} : o;
	  console.log(o);

	  var menu = (0, _jquery2.default)('<div/>');
	  var wWin = (0, _jquery2.default)(window).width();
	  var hWin = (0, _jquery2.default)(window).height();
	  menu.attr({
	    id: 'menu'
	  ...
	  o.items.forEach(function (item) {
	    var itemHtml = (0, _jquery2.default)('<div/>');
	    itemHtml.addClass('menu-item').css({
	      left: item.x * k + 'px',
	      top: item.y * k + 'px',
	      width: 40 * k + 'px',
	      height: 20 * k + 'px'
	  ...
	  (0, _jquery2.default)('#buttons').append(menu);
	};

/***/ },
/* 320 */
/*!********************************************!*\
  !*** ./_src/app/utils/menu/remove-menu.js ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var removeMenu = exports.removeMenu = function removeMenu() {
...
/***/ function(module, exports) {
	...
	var maxScaleRatio = 4;
	var scaleRatio = window.devicePixelRatio; // window.devicePixelRatio
	var scaleRatioSprite = scaleRatio / maxScaleRatio;

	var getRatio = exports.getRatio = {
	  ratio: scaleRatio,
...
/* 323 */
/*!*************************************************!*\
  !*** ./_src/app/utils/get-weapons-positions.js ***!
  \*************************************************/
/***/ function(module, exports) {
	...
	var getWeaponsPositions = exports.getWeaponsPositions = function getWeaponsPositions() {
	  var widthAttack = 630 * scaleRatio;
	  ...
	  for (var i = 0; i < 8; i++) {
	    var x = distance8 + i * distance8 + (undefined.width / 2 - widthAttack / 2);
	    var y = 0;
	    var position = {
	      x: x,
	      y: y
...
/***/ function(module, exports) {
	...
	var getRadians = exports.getRadians = function getRadians(degrees) {
...
/***/ function(module, exports) {
	...
	var setCenter = exports.setCenter = function setCenter(objects) {
...
/* 326 */
/*!************************************************!*\
  !*** ./_src/app/utils/set-responsive-width.js ***!
  \************************************************/
/***/ function(module, exports) {
...
/* 327 */
/*!****************************************!*\
  !*** ./_src/app/utils/has-children.js ***!
  \****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var hasChildren = exports.hasChildren = function hasChildren(element, childName) {
	  var isHasChildren = (0, _jquery2.default)(element).find((0, _jquery2.default)(childName));
...
/***/ function(module, exports) {
	...
	var setStorage = exports.setStorage = function setStorage(name, value) {
...
/* 329 */
/*!******************************************!*\
  !*** ./_src/assets/images/loader-bg.png ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "images/loader-bg.png";

/***/ },
/* 330 */
/*!*******************************************!*\
  !*** ./_src/assets/images/loader-bar.png ***!
  \*******************************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "images/loader-bar.png";

/***/ },
/* 331 */
/*!******************************************!*\
  !*** ./_src/assets/images/splash-bg.png ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "images/splash-bg.png";

/***/ },
/* 332 */
/*!********************************************!*\
  !*** ./_src/assets/images/splash-logo.png ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "images/splash-logo.png";

/***/ },
/* 333 */
/*!********************************************!*\
  !*** ./_src/assets/images/enemies/bug.png ***!
  \********************************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "images/bug.png";

/***/ },
/* 334 */
/*!*************************************!*\
  !*** ./_src/assets/images/coin.png ***!
  \*************************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "images/coin.png";

/***/ },
/* 335 */
/*!******************************************!*\
  !*** ./_src/assets/images/wall/wall.png ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 336 */
/*!*****************************************************!*\
  !*** ./_src/assets/images/weapons/weapon-gun-2.png ***!
  \*****************************************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "images/weapon-gun-2.png";

/***/ },
/* 337 */
/*!******************************************************!*\
  !*** ./_src/assets/images/weapons/weapon-base-2.png ***!
  \******************************************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "images/weapon-base-2.png";

/***/ },
/* 338 */
/*!********************************************************!*\
  !*** ./_src/assets/images/weapons/weapon-range-w1.png ***!
  \********************************************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "images/weapon-range-w1.png";

/***/ },
/* 339 */
/*!*****************************************!*\
  !*** ./_src/assets/images/3d/car-1.png ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "images/car-1.png";

/***/ },
/* 340 */
/*!***********************************************!*\
  !*** ./_src/assets/images/levels/level-1.png ***!
  \***********************************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "images/level-1.png";

/***/ },
/* 341 */
/*!***********************************************!*\
  !*** ./_src/assets/images/levels/level-2.png ***!
  \***********************************************/
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "images/level-2.png";

/***/ },
/* 342 */
/*!***********************************************!*\
  !*** ./_src/app/states/splash/splash-boot.js ***!
  \***********************************************/
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function preload() {
	      ...
	      this.load.onLoadComplete.add(function () {
	        console.log('loaded');
	        _this2.game.stage.backgroundColor = '#8BC34A';
	      }, this);
	    }
	  }, {
	    key: 'create',
...
/* 343 */
/*!***********************************************!*\
  !*** ./_src/app/states/splash/splash-play.js ***!
  \***********************************************/
/***/ function(module, exports, __webpack_require__) {
...
/* 344 */
/*!******************************************!*\
  !*** ./_src/app/states/battle/battle.js ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _create = __webpack_require__(/*! ./create */ 345);
	...
	var sets = _utils.U.mem.get('sets');
	var user = sets.user;
	var car = sets.cars[user.car];
	car.data = {};
	car.data.life = car.life;
	var carDron = sets.drons[user.dron];
	var isPaused = false;
	var drons = [];
	var dronsObj = {};
	var aliveEnemies = 0;
	var bg = void 0;
	var coins = void 0;
	var userMoney = void 0;
	var carLife = void 0;
	var enemiesLayer = void 0;
	var defenseLayer = void 0;
	var userStatsLayer = void 0;
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      var levelId = +_utils.U.mem.get('level');
	      var subLevelId = +_utils.U.mem.get('subLevel');

	      var level = sets.levels.filter(function (level_) {
	        return level_.id === levelId;
	      })[0];
	      var subLevel = level.subLevels.filter(function (subLevel_) {
	        return subLevel_.id === subLevelId;
	      })[0];

	      bg = this.game.add.tileSprite(0, this.game.height / 2, this.game.width * _utils.U.ratio, 1024, 'level-2');
	      bg.enableBody = true;
	      bg.name = 'bg';
	      bg.anchor.setTo(0, 0.5);
	      bg.scale.setTo(_utils.U.ratioS, _utils.U.ratioS);

	      var levelLayer = this.game.add.group();
	      enemiesLayer = this.game.add.group();
	      defenseLayer = this.game.add.group();
	      var dronsLayer = this.game.add.group();
	      var rangeLayer = this.game.add.group();
	      userStatsLayer = this.game.add.group();

	      var levelBg = levelLayer.create(this.game.width / 2, this.game.height / 2, 'level-1');
	      levelBg.enableBody = true;
	      levelBg.name = 'levelBg';
	      levelBg.anchor.setTo(0.5, 0.5);
	      levelBg.scale.setTo(_utils.U.ratioS, _utils.U.ratioS);
	      levelBg.animations.add('ride', [0, 1, 2, 3, 5, 6, 7], 30, true);
	      levelBg.frame = 0;

	      coins = userStatsLayer.create(20 * _utils.U.ratio, 20 * _utils.U.ratio, 'coin');
	      coins.enableBody = true;
	      coins.name = 'coins';
	      coins.anchor.setTo(0.5, 0.5);
	      coins.scale.setTo(_utils.U.ratioS, _utils.U.ratioS);
	      coins.animations.add('rolling', [7, 0, 1, 2, 3, 5, 6, 7], 20, false);
	      coins.frame = 7;
	      // coins.animations.play('rolling');

	      userMoney = this.add.text(40 * _utils.U.ratio, 20 * _utils.U.ratio, user.money + ' ' + user.score);
	      userMoney.font = 'Arial, Helvetica, sans-serif';
	      userMoney.fontSize = 20 * _utils.U.ratio;
	      userMoney.fill = '#fff';
	      userMoney.anchor.setTo(0, 0.5);
	      userMoney.inputEnabled = true;
	      userStatsLayer.add(userMoney);

	      carLife = this.add.text(this.game.world.width - 10 * _utils.U.ratio, 20 * _utils.U.ratio, car.data.life);
	      carLife.font = 'Arial, Helvetica, sans-serif';
	      carLife.fontSize = 20 * _utils.U.ratio;
	      carLife.fill = '#fff';
	      carLife.anchor.setTo(1, 0.5);
	      carLife.inputEnabled = true;
	      userStatsLayer.add(carLife);

	      var x = car.width * _utils.U.ratio + 500;
	      var y = this.game.height / 2;

	      var carModel = defenseLayer.create(x, y, 'car-1');
	      carModel.enableBody = true;
	      carModel.frame = 0;
	      carModel.name = 'car';
	      carModel.anchor.setTo(0.5, 0.5);
	      carModel.scale.setTo(_utils.U.ratioS, _utils.U.ratioS);
	      ...
	      for (var i = 0; i < subLevel.enemies.length; i++) {
	        console.log(subLevel.enemies[i]);
	        for (var j = 0; j < subLevel.enemies[i].count; j++) {
	          var _x = subLevel.enemies[i].x;
	          var _y = this.game.height / subLevel.enemies[i].count * (j + 1);
	          var name = 'enemy-' + subLevel.enemies[i].type;
	          var enemy = sets.enemies[subLevel.enemies[i].type];

	          var enemyModel = enemiesLayer.create(_x, _y, name);
	          ...
	          enemyModel.scale.setTo(_utils.U.ratioS, _utils.U.ratioS);
	          enemyModel.physicsBodyType = _phaser2.default.Physics.ARCADE;
	      ...
	      enemiesLayer.children.forEach(function (enemy) {
	        enemy.body.enable = false;
	      });

	      var btnPlay = _utils.U.btns.add({
	        x: 10,
	        y: _utils.U.view.h - 50,
	        w: 40,
	        h: 40,
	      ...
	      var btnPause = _utils.U.btns.add({
	        x: 10,
	        y: _utils.U.view.h - 50,
	        w: 40,
	        h: 40,
	        ...
	        click: function click() {
	          ...
	          _utils.U.menu.add({
	            items: [{
	              ...
	              click: function click() {
	                _this2.state.start('Battle');
	              }
	            }, {
	              label: '<span class="icon-cog"></span> Settings',
	              click: function click() {
	                _this2.state.start('Settings');
	              }
	            }, {
	      ...
	      var btnBoost = _utils.U.btns.add({
	        x: _utils.U.view.w - 108,
	        y: _utils.U.view.h - 50,
	        w: 40,
	        h: 40,
	        click: function click() {
	    ...
	    value: function update() {
	      ...
	      this.game.physics.arcade.collide(enemiesLayer, defenseLayer, function (enemy, dron) {
	        var x = Math.round(Math.random() * (2 * enemy.body.x));
	        var y = Math.round(Math.random() * (2 * enemy.body.y));

	        x = x > 0 ? x * -1 : x;

	        if (enemy.body.y <= _this3.game.world.height / 2) {
	          y = y * -1;
	        }
	        ...
	        _this3.game.add.tween(enemy).to({ angle: 720 }, 2000, _phaser2.default.Easing.Linear.None, true);
	      ...
	      aliveEnemies = enemiesLayer.children.filter(function (enemy) {
	        return enemy.alive;
	      });

	      if (aliveEnemies.length === 0) {
	        _utils.U.mem.set('sets', sets);
	        _utils.U.mem.set('win', 1);
	        this.state.start('Win');
	      } else if (car.data.life <= 0) {
	        _utils.U.mem.set('sets', sets);
	        _utils.U.mem.set('win', 0);
	        this.state.start('Win');
	      }
...
/* 345 */
/*!************************************************!*\
  !*** ./_src/app/states/battle/create/index.js ***!
  \************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _addDrons = __webpack_require__(/*! ./add-drons */ 346);

	Object.keys(_addDrons).forEach(function (key) {
	  if (key === "default" || key === "__esModule") return;
	  Object.defineProperty(exports, key, {
	    enumerable: true,
	    get: function get() {
	      return _addDrons[key];
	    }
	  });
	});

	var _addButtons = __webpack_require__(/*! ./add-buttons */ 347);

	Object.keys(_addButtons).forEach(function (key) {
	  if (key === "default" || key === "__esModule") return;
	  Object.defineProperty(exports, key, {
	    enumerable: true,
	    get: function get() {
	      return _addButtons[key];
	    }
	  });
	});
...
/* 346 */
/*!****************************************************!*\
  !*** ./_src/app/states/battle/create/add-drons.js ***!
  \****************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	exports.AddDrons = undefined;

	var _utils = __webpack_require__(/*! ../../../utils */ 306);

	var AddDrons = exports.AddDrons = {
	  init: function init(ctx) {
	    var dronsLength = ctx.car.dronsAmount;

	    console.log(dronsLength);

	    for (var i = 0; i < dronsLength; i++) {
	      var x = ctx.game.width / dronsLength * (i + 1) - ctx.game.width / dronsLength / 2;
	      var y = ctx.game.height - 40 * _utils.U.ratio;
	      var dronId = 'dron' + i;
	      ...
	      var range = ctx.rangeLayer.create(x, y, 'range-w1');
	      range.enableBody = true;
	      range.frame = 0;
	      range.name = 'range';
	      range.dron = dronId;
	      range.anchor.setTo(0.5, 0.5);
	      range.scale.setTo(_utils.U.ratioS, _utils.U.ratioS);
	      ctx.game.physics.arcade.enable(range);
	      range.body.immovable = true;

	      var dron = ctx.dronsLayer.create(x, y, 'w1');
	      dron.enableBody = true;
	      dron.name = 'dron';
	      dron.anchor.setTo(0.5, 0.5);
	      dron.scale.setTo(_utils.U.ratioS, _utils.U.ratioS);
	      dron.frame = 3;
	    ...
	    ctx.dronsLayer.children.forEach(function (dron) {
	      if (dron.name === 'dron') {
	        dron.visible = false;
	      }
	    });
...
/* 347 */
/*!******************************************************!*\
  !*** ./_src/app/states/battle/create/add-buttons.js ***!
  \******************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	exports.AddButtons = undefined;

	var _utils = __webpack_require__(/*! ../../../utils */ 306);

	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

	var AddButtons = exports.AddButtons = function AddButtons() {
	  _classCallCheck(this, AddButtons);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      _utils.U.title.add({
	        click: function click() {
	          _this2.state.start('Home');
	        },
	        cls: 'title-home'
	      });

	      var menuLeft = _utils.U.view.w / 4 * 3 - 107;

	      _utils.U.btns.add({
	        x: menuLeft,
	        y: _utils.U.view.h / 2 - 125,
	      ...
	      _utils.U.btns.add({
	        x: menuLeft,
	        y: _utils.U.view.h / 2 - 73,
	        label: '<span class="icon-lab"></span> Laboratory',
	        click: function click() {
	          console.log('click');
	          _this2.state.start('Lab');
	        },
	        cls: 'btn-home-menu'
	      });
	      ...
	      _utils.U.btns.add({
	        x: menuLeft,
	        y: _utils.U.view.h / 2 - 21,
	        label: '<span class="icon-coin-dollar"></span> Market',
	        click: function click() {
	          console.log('click');
	          _this2.state.start('Market');
	        },
	        cls: 'btn-home-menu'
	      });
...
/* 349 */
/*!**********************************************!*\
  !*** ./_src/app/states/settings/settings.js ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      var x = this.game.width - 74 * _utils.U.ratio;
	      var y = 10 * _utils.U.ratio;
...
/* 351 */
/*!******************************************!*\
  !*** ./_src/app/states/market/market.js ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      _utils.U.btns.add({
	        type: 'back',
	        click: function click() {
	          if ((0, _jquery2.default)('.map-item').hasClass('opened')) {
	            (0, _jquery2.default)('.map-item').removeClass('opened');
	            (0, _jquery2.default)('.map-item').removeClass('hidden');
	            (0, _jquery2.default)('.title-suffix').remove();
	          } else {
	            _this2.state.start('Home');
	          }
	        }
	      ...
	      var map = _utils.U.map.add(sets.levels, this);
	    }
	  }]);
	...
	var _class = function (_Phaser$State) {
	  ...
	  _createClass(_class, [{
	    ...
	    value: function create() {
	      ...
	      var sets = _utils.U.mem.get('sets');
	      var user = sets.user;
	      var isWin = +_utils.U.mem.get('win');
	      ...
	      if (isWin) {
	        _utils.U.cnt.add('<h1>You won!</h1><h1>Congratulations</h1>', { x: 20, y: 100 });
	      } else {
	        _utils.U.cnt.add('<h1>You loose...</h1><h1>Try again!</h1>', { x: 20, y: 100 });
	      }
	      _utils.U.cnt.add('<h4>Your money: ' + user.money + '</h4>', { x: 20, y: 140 });
	      _utils.U.cnt.add('<h4>Your score: ' + user.score + '</h4>', { x: 20, y: 180 });

	      _utils.U.btns.add({
	        x: _utils.U.view.w / 2 - 60,
	        y: _utils.U.view.h - 50,
	        w: 120,
	        h: 40,
	        click: function click() {
